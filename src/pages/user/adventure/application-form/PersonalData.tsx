...
export function PersonalData() {
  ...
  function changeTimeExpOption(option: string) {
    setselectedTimeExp(option)
  }
  function changeTimeAvaiable(option: string) {
    setSelectedTimeAvaiable(option)
  }
    ...
    <form className="mx-auto mt-14 flex w-[29rem] flex-col gap-10 text-gray-800">
      <Input.Root ariaLabel="Quanto tempo de experiência profissional você possui?">
        <Input.Select
          ...
          changeOption={changeTimeExpOption}
        />
      </Input.Root>
      ...
      <Input.Root ariaLabel="Quanto tempo você tem disponível para o programada?">
        <Input.Select
          ...
          changeOption={changeTimeAvaiable}
        />
      </Input.Root>
