          ...
          <div className="mt-10 flex w-full justify-between gap-6">
            <div className="flex w-full flex-col gap-2">
              ...
              <Select.Root onValueChange={setDayValue}>
                <Select.Trigger
                  id="day"
                  className="flex w-full items-center justify-between rounded bg-zinc-50 px-4 py-3 text-sm text-zinc-500 placeholder:text-zinc-200"
                >
                    ...
                    <Select.Viewport className="max-h-60 w-full cursor-pointer p-2 text-violet-500">
                      {days.map((days, index) => (
                        <Select.Item
                          key={index}
                          value={`${days}`}
                          className="flex items-center justify-between rounded-lg px-4 py-2 outline-none hover:bg-violet-500 hover:text-white"
                        >
                    ...
                    <Select.Viewport className="max-h-60 w-full cursor-pointer bg-zinc-50 p-2 text-violet-500">
                      {months.map((month, index) => (
                        <Select.Item
                          key={index}
                          value={`${month}`}
                          className="flex items-center  justify-between rounded-lg px-2 py-2 outline-none hover:bg-violet-500 hover:text-white"
                        >
                          <Select.ItemText>
                            {monthFormated(month)}
                          </Select.ItemText>
