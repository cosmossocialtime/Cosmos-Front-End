...
interface AboutInstitutionProps {
  nextPage: () => void
}

export function AboutInstitution({ nextPage }: AboutInstitutionProps) {
  ...
  useEffect(() => {
    ...
    if (focalPointData) {
      ...
      if (focalPointData.termsAccepted !== undefined) {
        console.log(
          '📢 Termos aceitos na tela anterior:',
          focalPointData.termsAccepted,
        )
        setPreviousTermsAccepted(focalPointData.termsAccepted)
      }
      if (focalPointData.focalPointAccepted !== undefined) {
        console.log(
          '📢 Termos aceitos nesta tela:',
          focalPointData.focalPointAccepted,
        )
    ...
    if (aboutInstitutionData) {
      console.log(
        '📢 Dados da AboutInstitution recuperados:',
      ...
      if (aboutInstitutionData.estado) {
        setSelectedEstado(
          estados.find((e) => e.value === aboutInstitutionData.estado) || null,
        )
      }
      if (aboutInstitutionData.cidade) {
        setSelectedCidade(
          cidades.find((c) => c.value === aboutInstitutionData.cidade) || null,
        )
      }
    } else {
      console.log(
        '⚠️ Nenhum dado encontrado no localStorage para AboutInstitution.',
      )
    }
