    ...
    <div className="relative">
      ...
      >
        <div>
          ...
          {showside && (
            <Link
              ...
              className="mx-auto mb-2 block text-center font-semibold text-blue-400"
            >
            ...
            {SideBarItems.map((item) => {
              return (
                <Link
                  ...
                  } z-[1] flex items-center gap-4 rounded-lg border border-solid border-transparent p-2 text-white transition-colors hover:border-violet-500`}
                >
                  <span
                    className={`${
                      pathname === item.route ? 'bg-purple-600' : 'bg-white/10'
                    } rounded-full p-3 text-2xl 2xl:p-4`}
                  >
                    {item.icon}
                  </span>
        ...
        <div
          className={`${
            showside ? '' : 'hidden'
          } mt-auto flex flex-col bg-blue-900 p-2 text-white`}
        >
