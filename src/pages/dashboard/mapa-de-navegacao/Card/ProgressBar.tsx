...
export function ProgressBar({ amountTask = 0, completedTask = 0 } : ProgressBarProps) {
    ...
    return (
        ...
        >
            ...
            />
            <circle
                className='fill-none blur-sm [stroke-width:8px] stroke-[url(#GradientColor)] group-hover:stroke-white'
                style={{
            ...
            />
            <circle
                className='fill-none [stroke-width:8px] stroke-[url(#GradientColor)] group-hover:stroke-white'
                style={{
                    strokeDasharray: circumferenceSize,
                    strokeDashoffset: completedSize,
                }}
