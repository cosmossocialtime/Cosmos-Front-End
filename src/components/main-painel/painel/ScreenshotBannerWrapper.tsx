...
export function ScreenshotBannerWrapper({
    ...
    return (
        <div>
            ...
            <button
                className={`flex h-12 w-full items-center justify-center gap-2 rounded-md bg-[#0A84FF] px-4 text-base font-semibold text-white transition hover:bg-[#006FE0] ${profilePhoto || profilePhoto !== ''
                        ? ''
