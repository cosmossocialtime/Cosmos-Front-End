            ...
            return (
              ...
              >
                ...
                <Dialog.Portal>
                  ...
                  <Dialog.Content className="fixed left-1/2 top-1/2 z-20 flex  w-[60vw] flex-1 -translate-x-1/2 -translate-y-1/2 flex-col gap-10 rounded-2xl bg-violet-900 px-10 py-8">
