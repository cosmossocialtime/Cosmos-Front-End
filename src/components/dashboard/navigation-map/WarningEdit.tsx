...
export default function WarningEdit() {
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed left-1/2 top-1/2 z-50 flex -translate-x-1/2 -translate-y-1/2 flex-col gap-8 rounded-lg bg-blue-900 p-10">
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="w-52 rounded-lg bg-red-500 py-4 text-center font-semibold text-white transition-colors hover:bg-red-600">
            Sair
          </button>
        </div>
      </Dialog.Content>
