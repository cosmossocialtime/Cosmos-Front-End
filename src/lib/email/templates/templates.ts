     ...
     style="display: block; width: 100%; max-width: 600px; height: auto;" />
      ...
      <tr>
        <td style="padding: 40px 40px 20px 40px; color: #1F103F;">
          <h2 style="margin-top: 0;">Olá ${name},</h2>
          <p style="font-size: 16px; line-height: 1.6;">
            Recebemos uma solicitação para atualizar o e-mail vinculado à sua conta na Cosmos. Para que essa alteração seja concluída com segurança, pedimos que você confirme a troca clicando no botão abaixo:
          ...
          <p style="font-size: 16px; line-height: 1.6;">
            Assim que a confirmação for feita, sua conta será atualizada com o novo e-mail, e você poderá continuar explorando e contribuindo com a nossa missão de impacto social sem interrupções.
          </p>

          <p style="font-size: 16px; line-height: 1.6;">
            Se você não solicitou essa alteração ou tiver qualquer dúvida, entre em contato com a gente. Estamos por aqui para ajudar!
          </p>
